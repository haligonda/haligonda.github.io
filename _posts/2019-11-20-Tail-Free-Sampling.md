...
Though this project is stuck at empirical validation, I urge researchers to consider using Tail Free Sampling for their open generation tasks if they find its underlying motivations compelling. Existing methods like Nucleus and Top-K Sampling also rely upon theory alone, making Tail Free Sampling both a useful and competitive alternative.

Update (Feb. 2022) - Tail Free Sampling is now being used in [production](https://goose.ai/playground) and discussed by groups like [ElutherAI](https://www.eleuther.ai/). However, I still am unaware of any statistically significant direct comparisons with other methods.

![Goose](../images/TailFreeSampling/GooseAI.png){:style="width: 700px;"}

<div align="center">
  <img width="500"  src="../images/TailFreeSampling/ElutherAIChat.jpg">
</div>
...
Funding for this project was provided indirectly through my parents; the Robertson Scholars Leadership Program; and the Google Cloud Platform's free trial credits.
