...
I am really glad my finals schedule allowed me to spend a week in Vancouver at NeurIPS 2019. NeurIPS provided me with a bird’s eye view of current progress in ML and what it takes to publish at a top ML conference. I also met some wonderful people and left with a number of new research directions like a kid trick-or-treating on Halloween.

For my own retention and the curiosity of friends who weren’t able to attend the conference, I am highlighting the research I found the most exciting while also summarizing my overall thoughts on the conference and state of ML. and go on to cite the papers and poster I found the most exciting.
...
Between the poster sessions and spotlight talks, NeurIPS provided a birds eye view of the field and there are a number of research directions I found really exciting grouped by general category:
...
* Generative Models:
    * Energy based
	    * Duvenaud - https://arxiv.org/pdf/1912.03263.pdf
	    * Implicit Generation and Generalization with Energy Based Models
        * Energy-Inspired Models - Google Brain Dieterich Lawson
